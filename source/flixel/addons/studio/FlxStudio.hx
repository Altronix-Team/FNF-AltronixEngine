...
@:bitmap("assets/preload/images/flixel-studio/icons/library.png")
class LibraryWindowToggle extends BitmapData
{
}

@:bitmap("assets/preload/images/flixel-studio/icons/Entities.png")
 ...
 * @see https://github.com/Dovyski/flixel-studio
 */
