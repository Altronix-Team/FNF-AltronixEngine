...
class AnimationDebug extends altronixengine.states.MusicBeatState
{
	...
	function saveBoyOffsets():Void
	{
		...
		var start = '{';
		var name = '"name": ' + '"' + char.curCharacter + '"';
		var asset = '"asset": "character/"';
		var barColorJson = '"barColorJson": [255, 255, 255]';
		var startingAnim = '"startingAnim": "idle"';
		var graphicsize = '"graphicsize": ""';
		...
		if ((result != null) && (result.length > 0))
		{
			...
			_file.save(result.trim(), char.curCharacter + ".json");
		}
	}
