...
@:bitmap("assets/preload/images/flixel-studio/icons/emitter.png")
class GraphicEmitterIcon extends BitmapData
{
}

@:bitmap("assets/preload/images/flixel-studio/icons/group.png")
class GraphicGroupIcon extends BitmapData
{
}

@:bitmap("assets/preload/images/flixel-studio/icons/lock.png")
class GraphicLockIcon extends BitmapData
{
}

@:bitmap("assets/preload/images/flixel-studio/icons/sprite.png")
class GraphicSpriteIcon extends BitmapData
{
}

@:bitmap("assets/preload/images/flixel-studio/icons/tilemap.png")
class GraphicTilemapIcon extends BitmapData
{
}

@:bitmap("assets/preload/images/flixel-studio/icons/visibility.png")
class GraphicVisilityIcon extends BitmapData
{
}

@:bitmap("assets/preload/images/flixel-studio/icons/x.png")
class GraphicXIcon extends BitmapData
{
}

@:bitmap("assets/preload/images/flixel-studio/icons/dot.png")
